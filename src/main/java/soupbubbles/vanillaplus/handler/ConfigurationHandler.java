...
public class ConfigurationHandler
{
    ...
    public static void initConfiguation(File configFile)
    {
        if (configuration == null)
        {
            ...
            firstLoad = true;
            MinecraftBoom.instance.logger.log(Level.INFO, "No configuration file for Vanilla Plus was found, creating new one");
        }

        // General
        minecraftBoomButton = loadCategory("Enable Vanilla Plus Button", Configuration.CATEGORY_GENERAL, "Enabling allows the Vanilla Plus button to appear in the Options menu. The Vanilla Plus configuration can always be reached through Mods -> Vanilla Plus -> Config.", true);
        ...
        tryGenerateRose = loadPropBool("Try Generating Inspiration Roses", CATEGORY_COMPAT, "Enabling will allow Vanilla Plus to generate the Rose from Inspiration since the mod doesn't add worldgen.", false, "Inspirations Compatibility");
